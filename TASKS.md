...
| WEB-003 | Review the merged landing (PR #27) on the live site across Safari, Firefox (no view transitions), iOS and Android touch; fix anything off | Codex | `codex/landing-review` | Backlog | — |
| WEB-004 | Refine landing navigation motion and simplify the Earth presentation | Codex | `codex/landing-motion` | Review | [PR #30](https://github.com/LonghandResearch/longhandresearch.github.io/pull/30) |
