...
| RPT-005 | Incorporate primary IDX statistics and BI JISDOR into the IHSG Update | Codex | `codex/ihsg-primary-data` | Review | [PR #25](https://github.com/LonghandResearch/longhandresearch.github.io/pull/25) |
