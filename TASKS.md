...
| RPT-003 | Add restrained chart animation to the IHSG Update and publish | Codex | `codex/ihsg-chart-motion` | Review | [PR #23](https://github.com/LonghandResearch/longhandresearch.github.io/pull/23) |
